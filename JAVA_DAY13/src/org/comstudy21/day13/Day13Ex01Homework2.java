...
public class Day13Ex01Homework2 {
	// 배열 필드 선언
	final int MAX = 10;
	String[] name, grade;
	...
	public void modify1() {
		if (searCnt == 1) {
			...
			if (flag) {
				kor[mIdx] = getIntScore("변경 국어 점수22: ");
